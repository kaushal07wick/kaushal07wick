...
- **FamAgent** — modular agent orchestration with a FastAPI backend.  
  https://github.com/kaushal07wick/FamAgent
- **Finsight / sqlagent** — financial analytics engine and Airflow + FastAPI tooling.  
  https://github.com/kaushal07wick/sqlagent
- **BreeBoost** — real-time fraud detection pipeline with drift monitoring and alerting.  
  https://github.com/kaushal07wick/breeboost
- **LanceDB contributions** — ingestion and vector search integration work.
